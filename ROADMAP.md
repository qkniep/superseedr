...
- **Scriptability and CLI Enhancements:** Torrent management and period stats made avaliable.
...
An addtional requirement is to have the codebase in a place for maximum extensability for the big features above.
Technical and non-technical documentation are also updated to the latest versions.
...
Heavy regression testing will take up a lot of time in this release, possible a beta program.
